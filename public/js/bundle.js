...
var displayMap = exports.displayMap = function displayMap(locations) {
  var map = L.map('map', _defineProperty({
    attributionControl: false,
    zoomControl: false,
    scrollWheelZoom: false,
    doubleClickZoom: false,
    zoomSnap: 0.1
  }, "zoomControl", false)); //to disable + - zoom
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51RBBRS4g4ndWAMg5bM5v0lBB7WECbSs1A7zGwkEumauKiUePEHe7lLmRFXjWsf9xC1KJetSpbfSSn10ggrgI5wrD00csvAw74G');
          _context.prev = 1;
          _context.next = 4;
...
var bookBtns = document.querySelectorAll('.book-tour-btn');
if (mapbox) {
